...
document.querySelector("body").addEventListener("wheel", (event) => {
    ...
    let subHeadingImg = document.querySelector(".left-container .achivement");
    ...
    let bgColors = ["6411A9", "4E27CE", "0F113B", "17263C", "1457C1", "022A91", "01824D"];
    document.querySelector(".circle-scroll-bar svg").style.cssText = `background: #${bgColors[tempIndex]};`;
})
